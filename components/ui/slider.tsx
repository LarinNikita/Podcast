...
>(({ className, ...props }, ref) => (
    <SliderPrimitive.Root
        ...
        {...props}
    >
        <SliderPrimitive.Track className="relative h-1 w-full grow overflow-hidden rounded-full bg-black-6">
            <SliderPrimitive.Range className="absolute h-full cursor-pointer rounded-full bg-white-1" />
